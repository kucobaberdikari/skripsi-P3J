...
@section('content')
  <div class="card">
   <div class="card-header">
     <h3 class="card-title">DATA TRANSAKSI PERBAIKAN SELESAI</h3>
   </div>
   <div class="card-body">
        ...
        <td align="center"> 
          <div class="btn-group btn-group-toggle" data-toggle="buttons">
            ...
            <label class="btn bg-secondary">
              <a href="javascript:void(0)" data-id="{{$item->id}}" onclick="receiptsPost(event.target)">Invoice</a>
            </label>
          </div>
        </td>
       </tr>

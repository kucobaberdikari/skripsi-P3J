...
<html>
  <head>
    ...
    <title>Pengaduan Perbaikan {{$item['nama']}}</title>
  ...
  <body class="document">
    <section class="invoice" style="padding: 80px">
    <div class="row invoice-info" style="padding-top: 50px;padding-left:20px">
      <div class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
        <h3>Hi {{$item['nama']}},</h3>
        <p>terima kasih telah menggunakan layanan Perbaikan dari Telkom Indonesia Berikut keterangan hasil perbaikan 
          <br> yang telah dilakukan oleh teknisi kami :
      </div>
    </div>
    <div class="row">

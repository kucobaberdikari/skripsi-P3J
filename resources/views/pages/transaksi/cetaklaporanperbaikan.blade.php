...
@section('content')
  <div class="card">
   <div class="card-header">
    <h3 class="card-title">CETAK DATA TRANSAKSI PERBAIKAN SELESAI</h3>
   </div>
     ...
     <tr>
      ...
      <td>
         <div class="input-group mb-3" >
               ...
               <a href="" onclick="this.href='/transaksi/cetaklaporantransaksipertanggal/'+document.getElementById('tglawal').value+

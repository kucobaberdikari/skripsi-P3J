...
@section('content')
  ...
  <div class="card">
   <div class="card-header">
     <h3 class="card-title">DATA TRANSAKSI PERAWATAN SELESAI</h3>
   </div>
   <div class="card-body">
        ...
        <td align="center"> 
          <div class="btn-group btn-group-toggle" data-toggle="buttons">
            ...
            <label class="btn bg-secondary">
              <a href="javascript:void(0)" data-id="{{$item->id}}" onclick="receiptPost(event.target)">Invoice</a>
            </label>
          </div>
        </td>
       </tr>
 ...
 <div class="modal fade" id="post-modal" aria-hidden="true" >
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="form-group">
        <label class="col-sm-2">Jenis perawatan</label>
        <div class="col-sm-12">
 ...
 <script>
  ...
  $.ajax({
    ...
    success: function(response) {
      var redirectWindow = window.open(_url, '_blank');

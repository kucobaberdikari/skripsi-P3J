...
@section('content')
  ...
  <div class="card">
   <div class="card-header">
    <h3 class="card-title">CETAK DATA PERAWATAN TERPROSES</h3>
   </div>
     ...
     <tr>
      ...
      <td>
         <div class="input-group mb-3" >
               ...
               <a href="" onclick="this.href='/cetakperawatanpertgl/'+document.getElementById('tglawal').value+
      ...
      <td>
        ...
        <td>
         <button class="btn bg-red" type="button">
            <a href="" onclick="this.href='/eksporlaporanpertanggal/'+document.getElementById('tglawal').value+
